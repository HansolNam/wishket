...
<body class="logged-in client project-detail">
	...
	<div id="wrap">
		...
		<div class="page">
			<div class="content">
				<p class="back">
					<a href="/project/?status=true"><i
						class="fa fa-arrow-circle-o-left"></i> 프로젝트 찾기로 돌아가기</a>
				</p>
				<div class="content-inner">
					...
					<div class="project-detail-category">
						<%
							if(project.getCategoryL().equals("develop")) out.print("개발 &gt;"+project.getCategoryM());
							else out.print("디자인 &gt;"+project.getCategoryM());
						%> 
						   <span class="applicant-count pull-right"><img
							src="${pageContext.request.contextPath}/resources/static/img/proposal.png" style="margin-right: 5px;" />총 <span
							class="applicant-num">6명</span> 지원
							<% 
		 					int remain = Time.remainDate(project.getDeadline(), now);
		 					if(remain>=0) out.println("(모집 "+Time.remainWeekDate(remain)+" 전)");
				...
				<div class="content-inner" style="margin-top: 5px;">
					<div class="project-comment">
						...
						<div class="media">
							<a class="pull-left" href="#"><img alt="gksthf1611의 프로필 이미지"
								class="media-object" src="${pageContext.request.contextPath}/resources/static/img/default_avatar.png" /></a>
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.interest == 'false'){
                    ...
                    $(obj).find('#interest_action_img').attr('src', '${pageContext.request.contextPath}/resources/static/img/no-interested-project-default.png');
                }
                else{
                    obj.className = 'btn btn-large btn-project-application btn-default btn-block';
                    $('#interest_action_text').html('관심 프로젝트 삭제하기');
                    $(obj).find('#interest_action_img').attr('src', '${pageContext.request.contextPath}/resources/static/img/interested-project-default.png');
                }
            },
            error: function(data){
                console.log(data);
