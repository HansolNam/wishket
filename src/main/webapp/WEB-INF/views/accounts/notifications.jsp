...
<body class="logged-in client notification-list">
			...
			<div class="content">
				<div class="content-header">
					<h3 class="header-text">
						알림 <small class="small-text">gksthf16111님! 새로운 소식들을 확인하세요.</small>
					</h3>
				</div>
				<div class="content-inner">
					<section class="list-wrapper">
					<div class="notification-unit unread">
						<div>
							<div class="notification-object" style="*width: 50px;">
								<img alt="위시켓" class="notification-sender-image" height="50px"
									src="${pageContext.request.contextPath}/resources/static/img/wishket_logo.png?v2" width="50px" />
							</div>
						</div>
						<div class="notification-body">
							<p>
								<a class="notice-object"
									href="/client/manage/past/cancelled-project/">test</a> 프로젝트를
								취소하였습니다.
							</p>
							<span>2015. 8. 28. 19:04</span>
						</div>
						<a class="grid-block js-mark-as-read" href=""></a>
						<form action="/accounts/notifications/mark/76533"
							id="notification-form-76533" method="POST" style="display: none;">
							<input name="csrfmiddlewaretoken" type="hidden"
								value="7YCuiuWVSyxVfH1qjb8JOSXcBvfKqQBY" /><input
								checked="checked" id="id_mark_as_read" name="mark_as_read"
								style="display: none;" type="checkbox" /><input
								name="destination" type="text"
								value="/client/manage/past/cancelled-project/" /><input
								type="submit" value="읽음으로 표시" />
						</form>
					</div>
					<div class="notification-unit">
						...
						<div class="notification-body">
							<p>
								<a class="notice-object"
									href="/client/manage/project/submitted/">test</a> 프로젝트가 등록되어
								위시켓에서 검수 중입니다. 검수에는 최대 24시간이 소요됩니다.
							</p>
							<span>2015. 8. 28. 19:03</span>
						</div>
						<a class="grid-block" href="/client/manage/project/submitted/"></a>
					</div>
					</section>
				</div>
			</div>
	...
	<script src="${pageContext.request.contextPath}/resources/static/js/endless_pagination/endless-pagination.js"></script>
	<script>$.endlessPaginate();</script>
	<script>
    $(function () {
      $('.js-mark-as-read').click(function(e) {
          e.preventDefault();
