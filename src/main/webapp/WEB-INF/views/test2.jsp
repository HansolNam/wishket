...
<body class="logged-in client account-setting profile">
							...
							<ul class="nav navbar-nav navbar-right nav-secondary">
								...
								<li class="notification"><a
									...
									href="/accounts/notifications/"><i
										...
										class="badge badge-notification">2</span></a></li>
								<li class="dropdown"><a
								...
								<div class="p5-portfoilo-img-control-wrapper"
									...
									<div class="control-wrapper">
										<span class="p5-img-name" id="p5-image-name"
											style="margin-top: 8px;">profiles/28155_20150918_b8e4e483e337e5dc.png</span>
    ...
    $(document).ready( function() {
        ...
        $('#id_date_of_birth_year').val('1992');
        $('#id_date_of_birth_month').val('7');
        $('#id_date_of_birth_day').val('18');
    ...
    $(document).ready(function(){
        $('#form_of_business').val('individual');
        $('#form_of_business').change();
    });
    ...
    $(function () {
        ...
        getSigungu = function(value) {
            ...
            $.getJSON(url, function(j){
                var options,
                        $addressSigungu = $('input[name="address_sigungu"]'),
