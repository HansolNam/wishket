				...
				<div class="content">
					<div class="content-inner" style="padding-top: 15px;">
						<section class="p5-partition-title">
							<h3 class="header-text" style="margin-bottom: 30px">자기 소개 수정</h3>
						</section>
						<section>
							<div class="p5-content-body">
								<form class="form-horizontal has-validation-callback"
									...
									<input name="csrfmiddlewaretoken" type="hidden"
										value="JxPJzVZaSVw36WgQUc1277Obv7KtT3ss" />
									<div class="form-group p5-form-group">
										...
										<div class="control-wrapper">
											<textarea class="form-control" id="p5-description"
												name="description" rows="12">안녕하세요.</textarea>
										</div>
									...
									<div
										...
										<div class="btn-wrapper pull-right">
											<input class="btn btn-default btn-submit p5-btn-left"
												type="submit" value="수정" /><a
												class="btn btn-default btn-cancel"
												href="/partners/p/gksthf16112/introduction/update/">취소</a>
										</div>
									</div>
								</form>
							</div>
