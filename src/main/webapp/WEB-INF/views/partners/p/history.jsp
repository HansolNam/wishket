...
<title>위시켓(Wishket) · 파트너스 - gksthf16112</title>
...
<body class="logged-in partners partners-setting">
		...
		<div class="container">
			<div class="nav-inner">
				...
				<ul class="nav navbar-nav">
					<li class=" active "><a href="/partners/p/gksthf16112/"
				...
				<div class="sidebar">
					...
					<div class="sidebar-nav">
						<ul>
							...
							<li class="active"><a
								href="/partners/p/gksthf16112/history/">위시켓에서 진행한 프로젝트</a></li>
						</ul>
					</div>
				</div>
				<div class="content">
					<div class="content-inner" style="padding-top: 15px;">
							...
							<div class="profile-head-content-inner">
								...
								<div class="project-average-box" style="float: right">
									<div class="project-average-box-price">
										...
										<img src="/static/img/project_average_price.png" />
									...
									<div class="project-average-box-period">
										...
										<img height="14px"
											src="/static/img/project_average_period.png" width="199px" />
						...
						<div class="p5-empty-component-lg">
							<div class="p5-assign-component">
								<div>
									<img src="/static/img/project_history_no.png" />
    ...
    $(document).ready(function() {
        ...
        function setPagination(present, total){
            ...
            if(present != 1){
                html += "<li><a style='cursor:pointer' href='/partners/p/gksthf16112/history/?page="+prev+"' class='prev'><i class='fa fa-arrow-left'></i></a></li>";
            }
            for(var i = min_page; i<=max_page; ++i){
                html +="<li id='page_" + i + "'><a style='cursor:pointer' href='/partners/p/gksthf16112/history/?page="+i+"'>" + i + "</a></li>";
            }
            //html +="<li id='page_" + i + "'><a style='cursor:pointer' onclick='setPage(" + total + ");'>" + total + "</a></li>";
            if(present != total){
                html += "<li><a style='cursor:pointer' href='/partners/p/gksthf16112/history/?page="+next+"' class='next'><i class='fa fa-arrow-right'></i></a></li>";
            }
