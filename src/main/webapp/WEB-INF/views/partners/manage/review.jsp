	...
	<jsp:include page="../../header.jsp" flush="false" />
		...
		<div class="page">
			<div class="page-inner">
					<p class="back">
						<a href='/wjm/partners/manage/past/review-contract/'>[평가 대기중]으로 가기 <i
				...
				<div class="content">
					<div class="content-header action">
						<h3 class="header-text">
							평가하기 <small class="small-text">더 좋은 서비스를 위해 클라이언트를 평가해
								주세요.</small>
						</h3>
					</div>
					<div class="content-inner">
						...
						<h3 class="header-text" style="margin-bottom: 30px">클라이언트 평가</h3>
						</section>
						<section>
						<form action="/wjm/partners/manage/review/<%=contract.getProject_pk() %>/<%=contract.getClient_pk()%>/<%=contract.getPartners_pk()%>" id="review_form" method="POST"
							...
							<div class="form-group p5-form-group">
								...
								<div class="control-wrapper">
									<input class="form-control"
										...
										name="client_id" required="required" type="text" value="<%=contract.getClient_id() %>" disabled>
								</div>
							</div>
							<div class="form-group p5-form-group">
								<label class="control-label required p5-box-control-label"
							...
							<span class="pull-right"><a
								...
								href="/wjm/partners/manage/past/review-contract/" type="button">취소</a>
