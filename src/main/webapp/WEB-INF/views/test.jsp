...
<title>위시켓(Wishket) · 관리 - 임시 저장</title>
...
<body class="logged-in client client-management project-management">
			...
			<div class="page-inner">
				<div class="sidebar">
					...
					<div class="sidebar-nav">
						<ul>
							<li class=""><a href="/client/manage/project/submitted/">검수
									중</a></li>
							<li class="active"><a href="/client/manage/project/saved/"><span
									class="badge badge-info pull-right">1</span> 임시 저장</a></li>
							<li class=""><a href="/client/manage/project/rejected/">등록
									실패</a></li>
						</ul>
					</div>
				</div>
						...
						<section>
							<section class="project-unit">
								<section class="project-unit-heading">
									<h4 class="project-title">a</h4>
									<div class="management-tools">
										<a class="btn btn-sm btn-default" href="/project/edit/4905/">수정</a>
										<a class="btn btn-sm btn-cancel" data-toggle="modal"
											href="#saved-project-delete-modal-4905" role="button">삭제</a>
									</div>
								</section>
	...
	<div aria-hidden="true"
		aria-labelledby="saved-project-delete-modal-4905-label"
		class="modal fade" id="saved-project-delete-modal-4905" role="dialog"
		tabindex="-1">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="/project/delete/4905/" class="form-horizontal"
						enctype="multipart/form-data" id="saved-project-delete-form-4905"
						method="POST">
						<input name="csrfmiddlewaretoken" type="hidden"
							value="jHLyv3vf2UnZzNAvAOHKplG1LTrbIq1s" />
						<p>a을(를) 정말 삭제하시겠습니까?</p>
