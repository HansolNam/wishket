...
<body class="logged-in partners project-list">
	<div id="fb-root"></div>
						...
						<nav>
							<ul class="nav navbar-nav nav-primary">
								<li class=" active " style="color: #fff"><a
									href="/project/" style="color: #fff">프로젝트 찾기</a></li>
			...
			<div class="content">
				<div class="content-header">
					<h3 class="header-text">
						프로젝트 찾기 <small class="small-text"><span
							id="total_list_num">2,611개의 프로젝트가 있습니다.</span></small>
					</h3>
				...
				<div class="content-inner">
					...
					<div class="project-list-box" id="project-list-box"
						...
						<input id="project_total_number" type="hidden" value="2,611" /><input
							id="page_size" type="hidden" value="262" />
