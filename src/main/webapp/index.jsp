...
<body class=" landing">
	<div id="wrap">
						...
						<nav>
							...
							<span class="navbar-nav navbar-right"><span class="w-help"><a
									href="/wjm/service-intro/"><i
										class="fa fa-question-circle fa-lg"></i></a></span> <span class="w-login"><a
									class="btn btn-login" href="/wjm/accounts/login/"
									style="color: #fff">로그인</a></span> <span class="w-signup"><a
									class="btn btn-signup" href="/wjm/accounts/signup/"
									style="color: #fff">회원가입</a></span></span>
						</nav>
					</div>
				</div>
			</section>
		...
		<div class="jumbotron">
			<div class="jumbotron-inner">
				<div class="invitation">
					...
					<p class="invitation-text-sm">위시켓의 새로운 아웃소싱을 시작해 보세요</p>
					<a class="btn btn-client btn-lg project-add-btn"
						href="/project/add/">무료로 프로젝트 등록하기</a>
				</div>
			</div>
		</div>
		...
		<section class="landing-project-list">
			<div class="landing-inner">
				<div class="landing-project-list-heading">
					<h4>
						<img height="20px" src="${pageContext.request.contextPath}/resources/static/img/landing/symbol.png"
				...
				<div class="landing-project-item right">
					...
					<p class="landing-project-item-body">(주)메가북스 / 시작시점에 미팅, 주 1회
						미팅 / 기획 완료, 스토리보드 작성 중 / 100인규모 사업장 웹 ERP 및 전자결재 시스템 개발 / 1. 개..</p>
					<p class="project-skill-list">
						<span class="project-skill">mysql</span> <span
		...
		<section class="landing-process">
			<div class="landing-process-inner">
				<h4>
					<img height="20px" src="${pageContext.request.contextPath}/resources/static/img/landing/symbol.png"
						style="margin-top: -3px;" />위시켓 프로세스
				</h4>
				<img src="${pageContext.request.contextPath}/resources/static/img/landing/process.png" />
				<div>
		...
		<section class="landing-benefit">
			<div class="landing-inner">
				<div class="landing-benefit-title">
					<h4>
						<img height="20px" src="${pageContext.request.contextPath}/resources/static/img/landing/symbol.png"
							style="margin-top: -3px;" />빠르고 안전한 위시켓
					</h4>
				</div>
				<div class="benefit-item">
					<img src="${pageContext.request.contextPath}/resources/static/img/landing/benefit_first.png" />
					<h3 class="benefit-item-title">무료로 더 쉽게 프로젝트를 등록</h3>
					<p class="benefit-item-desc">
						원하는 프로젝트를<br />쉽고 빠르게 진행할 수 있습니다.<br />수많은 위시켓 파트너들에게<br />당신의
						프로젝트를 소개해 보세요.
					</p>
				</div>
				<div class="benefit-item">
					<img src="${pageContext.request.contextPath}/resources/static/img/landing/benefit_second.png"
						style="margin-left: 100px;" />
					<h3 class="benefit-item-title">실력있는 지원자를 한눈에 비교 선택</h3>
					<p class="benefit-item-desc">
						다양한 지원자들의 포트폴리오와<br />클라이언트의 평가를<br />비교할 수 있습니다.<br />위시켓의 전문가들을
						만나보세요.
					</p>
				</div>
				<div class="benefit-item">
					<img src="${pageContext.request.contextPath}/resources/static/img/landing/benefit_third.png" />
					<h3 class="benefit-item-title">안전한 대금 보호 및 확실한 비용 처리</h3>
					<p class="benefit-item-desc">
						위시켓은 에스크로 시스템을 통해<br />프로젝트 대금을 보호합니다.<br />세금계산서 발행, 계약서 작성 문제도<br />더
						이상 고민하지 마세요.
					</p>
				</div>
			</div>
		...
		<div class="landing-addendum">
			<div class="landing-inner">
				<div class="interview-list">
					<div class="landing-project-list-heading">
						<h4>
							<img height="20" src="${pageContext.request.contextPath}/resources/static/img/landing/symbol.png"
								style="margin-top: -3px;" />유저들이 말하는 위시켓
						</h4>
					</div>
					...
					<div class="interview-item third">
						<p class="interview-item-review">
							위시켓의 <strong>대금보호 서비스</strong>가<br />정말 만족스러웠다.<br />
		...
		<section class="landing-partnership">
			<div class="landing-inner">
				<div class="landing-project-list-heading">
					<h4>
						<img height="20px" src="${pageContext.request.contextPath}/resources/static/img/landing/symbol.png"
							style="margin-top: -3px;" />위시켓과 함께 합니다
					</h4>
					<img src="${pageContext.request.contextPath}/resources/static/img/landing/withyou.png" />
				</div>
			</div>
		</section>
		<section class="landing-with-company">
			<div class="landing-inner">
				<div class="landing-company-list-heading">
					<h4>
						<img height="20px" src="${pageContext.request.contextPath}/resources/static/img/landing/symbol.png"
							style="margin-top: -3px;" />위시켓 고객사
					</h4>
					<img src="${pageContext.request.contextPath}/resources/static/img/landing/company_img.png" />
				</div>
			</div>
		</section>
		<script>
    $(window).load(function () {
        ...
        function count(){
            ...
            $({someValue: 0}).animate({someValue: '2577'}, {
                duration: 1200,
            ...
            $({someValue: 0}).animate({someValue: ('21397260000')}, {
                duration: 1200,
                easing:'swing', // can be anything
                step: function() { // called on every step
                    // Update the element's text with rounded-up value:
            ...
            $({someValue: 0}).animate({someValue: '15169'}, {
                duration: 1200,
                easing:'swing', // can be anything
                step: function() { // called on every step
                    // Update the element's text with rounded-up value:
		...
		<div class="footer-inner">
			...
			<div class="category">
				...
				<ul class="category-list">
					<li class="category-item"><a href="/wjm/service-intro/">서비스 소개</a></li>
